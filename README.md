...
![Project Overview](docs/images/sql_projects_(data_warehouse_scope).pngg)
...
│     ├── sql_projects_(data_warehouse_scope)                # PNG file with project overview and scope of this part
|   ├── draw(io) templates
...
│     ├── sql_projects_(data_warehouse_scope) .drawio        # Draw.io file with project overview and scope of this part
